...
\begin{itemize}[left=0cm]
  ...
  \item Published a high-impact journal article (as $1^{st}$ author) and submitted a paper to an IEEE conference.
    ...
    \setlength\itemsep{-0.075em} % Adjust the spacing between items
    \setlength\parskip{-0.075em} % Adjust the spacing between paragraphs within items
        \item [1.] \justifying{\textbf{Syed Emad Uddin Shubha}, Mir Muzahedul Islam, Tanvir Ahahmed Sadi, Md. Hasibul Hasan Miraz, M.R.C. Mahdy. ``Implementation of a Modified QHED Algorithm for Better Edge Detection.'' (Manuscript Under Preparation).} 
       
        \item [2.] \justifying{Raiyan Rahman, Md Shawmoon Azad, Mohammed Rakibul Hasan, \textbf{Syed Emad Uddin Shubha}, M.R.C. Mahdy. \mbox{``A Secure Image} Transmission Scheme Using Chaotic System and Quantum Entanglement.''(In Preparation).} 
    \end{itemize}
\end{itemize}
